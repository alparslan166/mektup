...
export default function GiftOrderModal({
  ...
  const [availableCities] = useState<string[]>(
    Object.values(citiesData).sort((a, b) =>
  ...
  const [saveReceiverToAddressBook, setSaveReceiverToAddressBook] =
    useState(false);
      ...
      const fetchPrisons = async () => {
        ...
        try {
          const res = await fetch(
            `/api/prisons?city=${encodeURIComponent(selectedPrisonCity)}`,
          );
          if (res.ok) {
  ...
  const handleSelectAddress = (addr: Address) => {
    if (addressModalType === "sender") {
      ...
      const isPrisonAddr =
        !!addr.isPrison || !!addr.title.toLowerCase().includes("cezaevi");
          ...
          >
            ...
            {step === "FORM" && (
              <form
                ...
                className="flex flex-col h-full overflow-y-auto overflow-x-hidden p-6 sm:p-8 gap-8 custom-scrollbar"
              >
                <div className="text-center space-y-2 mt-2">
                  <div className="mx-auto w-16 h-16 bg-seal/10 rounded-full flex items-center justify-center text-seal mb-4">
                    <GiftIcon size={32} />
                  </div>
                  <h2 className="text-2xl font-playfair font-bold text-ink">
                    Hediye Siparişi
                  </h2>
                  <p className="text-ink-light text-sm">
                    Hediyenizi güvenle satın alın ve adres bilgilerini
                    tamamlayın.
                  </p>
                </div>
                ...
                <div className="bg-paper-dark/20 p-4 rounded-xl flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm font-playfair font-black text-seal">
                      {gift.price || 0} TL
                    </p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between border-b border-paper-dark pb-2">
                      <h3 className="font-playfair text-lg font-bold text-wood">
                        Gönderen Bilgileri
                      </h3>
                      <button
                        type="button"
                        onClick={() => openAddressModal("sender")}
                        className="text-xs font-semibold text-wood bg-wood/10 px-2 py-1 rounded"
                      >
                        Adres Defteri
                      </button>
                    </div>
                    <div>
                      <label className="text-xs font-bold text-ink-light block">
                        Ad Soyad *
                      </label>
                      <input
                        required
                        ...
                        className="w-full bg-white border border-paper-dark rounded-md px-3 py-2 text-sm mt-1"
                      />
                    </div>
                    <div>
                      <label className="text-xs font-bold text-ink-light block">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-white border border-paper-dark rounded-md px-3 py-2 text-sm mt-1 min-h-[60px]"
                      />
                    </div>
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) =>
                          setSaveSenderToAddressBook(e.target.checked)
                        }
                        className="rounded"
                      />
                      <label
                        htmlFor="saveSender"
                        className="text-xs text-ink-light cursor-pointer"
                      >
                        Adresi rehberime kaydet
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between border-b border-paper-dark pb-2">
                      <h3 className="font-playfair text-lg font-bold text-seal">
                        Alıcı Bilgileri
                      </h3>
                      <button
                        type="button"
                        onClick={() => openAddressModal("receiver")}
                        className="text-xs font-semibold text-seal bg-seal/10 px-2 py-1 rounded"
                      >
                        Adres Defteri
                      </button>
                    </div>
                    ...
                    <div className="flex items-center gap-3 bg-red-50/50 p-2 border border-red-100 rounded-md">
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          ...
                          checked={isPrison}
                          onChange={(e) => setIsPrison(e.target.checked)}
                        />
                    ...
                    {!isPrison ? (
                      ...
                      <>
                        <div>
                          ...
                          <select
                            required
                            value={selectedPrisonCity}
                            onChange={(e) =>
                              setSelectedPrisonCity(e.target.value)
                            }
                            className="w-full bg-white border border-paper-dark rounded-md px-3 py-2 text-sm mt-1"
                          >
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              const p = filteredPrisons.find(
                                (fp) => fp.name === e.target.value,
                              );
                              if (p) {
                        ...
                        <div>
                          <label className="text-xs font-bold text-ink-light block">
                            Cezaevi Mektup Notu (Opsiyonel)
                          </label>
                          <input
                            value={prisonNote}
                            onChange={(e) => setPrisonNote(e.target.value)}
                            placeholder="Anne adıyla gönderilecek, vb."
                            className="w-full bg-white border border-paper-dark rounded-md px-3 py-2 text-sm mt-1"
                          />
                        </div>
                      </>
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) =>
                          setSaveReceiverToAddressBook(e.target.checked)
                        }
                        className="rounded"
                      />
                      <label
                        htmlFor="saveReceiver"
                        className="text-xs text-ink-light cursor-pointer"
                      >
                        Adresi rehberime kaydet
                      </label>
                ...
                <div className="border-t border-paper-dark pt-4 mb-2">
                  <label className="text-sm font-bold text-ink-light mb-1.5 block">
                ...
                <button
                  ...
                  className={`w-full font-bold py-4 rounded-xl transition-all shadow-md active:scale-[0.98] flex items-center justify-center gap-2 mt-2 ${
                    agreedToTerms
            ...
            {step === "PROCESSING" && (
              <div className="p-12 flex flex-col items-center text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-ink font-playfair">
                  İşlem Gerçekleştiriliyor
                </h3>
                <p className="text-ink-light text-sm">
                  Ödemeniz alınıyor ve siparişiniz onaylanıyor, lütfen
                  bekleyin...
                </p>
              </div>
            )}
            ...
            {step === "SUCCESS" && (
              <div className="p-10 flex flex-col items-center text-center space-y-6">
                ...
                <h3 className="text-2xl font-bold text-ink font-playfair">
                  Sipariş Başarılı!
                </h3>
                <p className="text-ink-light text-sm max-w-[280px]">
                  Hediyeniz başarıyla satın alındı. Ödemeniz onaylandı. Kısa
                  sürede hazırlanıp yola çıkacaktır.
                </p>
                <button
                  onClick={resetModal}
                ...
                >
                  ...
                  >
                    ...
                    <div className="mb-6 flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-xl font-playfair font-bold text-ink">
                          Adres Defterim
                        </h3>
                        <p className="text-sm text-ink-light">
                          Kayıtlı adreslerinizden hızlıca seçim yapın
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="overflow-y-auto flex-1 custom-scrollbar pr-2">
                      {isLoadingAddresses ? (
                          ...
                          {addresses.map((addr) => (
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm font-semibold text-seal mt-1 truncate">
                                  {addr.name}
                                </p>
                        ...
                        <div className="text-center py-12">
                          <Building2
                            size={40}
                            className="mx-auto text-ink-light/30 mb-3"
                          />
