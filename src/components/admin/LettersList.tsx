                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex gap-2">
                                                        <input
                                                            ...
                                                            className="flex-1 bg-white/10 border border-white/20 rounded-lg px-4 py-2 text-sm outline-none focus:border-purple-400 transition-all"
                                                        />
                                                        <button
                                                            onClick={handleSaveTracking}
                                                            disabled={isUpdating || !trackingCode}
                                                            className="bg-purple-600 hover:bg-purple-700 px-4 py-2 rounded-lg text-sm font-bold disabled:opacity-50"
                                                        >
                                                            Kaydet
                                                        </button>
                                                    </div>
