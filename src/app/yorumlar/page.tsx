...
export default function YorumlarPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl flex-1 flex flex-col">
      <Link
        href="/"
        className="inline-flex items-center gap-2 text-ink-light hover:text-ink transition-colors mb-6 w-fit bg-paper/60 px-4 py-2 rounded-full backdrop-blur-sm border border-wood/10 shadow-sm"
      >
        <ArrowLeft size={16} />
      ...
      <div className="bg-paper shadow-md border border-paper-dark rounded-xl p-8 sm:p-12 relative overflow-hidden mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5 lg:col-span-4 flex flex-col items-center text-center">
            <h2 className="text-wood font-playfair font-bold text-xl mb-6 uppercase tracking-widest drop-shadow-sm">
              Ortalama Puan
            </h2>
            ...
            <div className="border border-wood/50 border-dashed rounded-lg p-8 w-full flex flex-col items-center justify-center bg-paper-light/50 relative shadow-inner">
              <div
                ...
                style={{
                  backgroundImage:
                    "radial-gradient(circle, #8b5a2b 1px, transparent 1px)",
                  backgroundSize: "16px 16px",
                  opacity: 0.1,
                }}
              ></div>

              <div className="text-5xl font-playfair font-bold text-ink mb-4 relative z-10">
              ...
              <div className="text-sm font-bold text-ink-light relative z-10">
                Toplam :{" "}
                <span className="text-ink">{totalCommentsCount} Yorum</span>
              </div>
            </div>
          ...
          <div className="md:col-span-7 lg:col-span-8 flex flex-col">
            <div className="mb-8 p-4 bg-[#effdf4] border border-[#bbf7d0] rounded-lg">
              <p className="text-ink font-medium text-[13px] mb-2">
                Soru ve sorunlarınızı lütfen WhatsApp hattımıza yazınız.
              </p>
              <a
                href="https://wa.me/908503058135"
                className="inline-flex items-center text-[#166534] hover:text-[#14532d] font-bold text-[15px] transition-colors"
              >
                <MessageCircle size={18} className="mr-2" /> WhatsApp Yardım (
                +90 541 944 68 48 )
              </a>
            </div>
            ...
            {!session ? (
              <div className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-paper-dark rounded-xl bg-paper-light/30">
                <p className="text-ink-light font-medium mb-4">
                  Yorum yazmak için giriş yapmalısınız.
                </p>
                <Link
                  href="/api/auth/signin"
                  className="bg-wood hover:bg-wood-dark text-paper font-bold py-2.5 px-8 rounded-md transition-colors shadow-sm text-sm"
                >
                  Giriş Yap
                </Link>
              </div>
                ...
                >
                  <div className="flex flex-col sm:flex-row gap-4 align-start">
                    ...
                    <div className="flex flex-col items-center justify-center p-4 w-full sm:w-28 shrink-0 bg-paper shadow-sm border border-paper-dark rounded-xl h-fit">
                      <div
                        className={`w-12 h-12 rounded-full border border-wood/20 flex items-center justify-center font-playfair font-bold text-lg mb-2 shadow-inner overflow-hidden ${getAvatarColor(comment.user.email || "guest")}`}
                      >
                    ...
                    <div className="flex-1 bg-paper shadow-sm border border-paper-dark rounded-xl p-5 sm:p-6 relative group flex flex-col justify-start">
                      <div className="flex justify-between items-start mb-2">
                        <h4 className="font-playfair italic font-bold text-lg text-wood-dark">
                          {comment.title || "Deneyim Paylaşımı"}
                        </h4>
                            ...
                            >
                              <div className="space-y-4">
                                {comment.replies.map((reply: any) => (
                                  <div
                                    key={reply.id}
                                    className="flex gap-3 bg-paper-light/50 p-3 rounded-lg border border-paper-dark/30"
                                  >
                                    <div
                                      className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-[10px] shrink-0 border border-paper-dark/50 ${getAvatarColor(reply.user.email || "guest")}`}
                                    >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-playfair font-bold text-ink mb-2">
                  Yorumu Sil
                </h3>
                <p className="text-sm text-ink-light mb-8 italic">
                  Bu yorumu ve varsa tüm yanıtlarını silmek istediğinize emin
