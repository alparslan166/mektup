      ...
      <div className="w-full max-w-4xl px-4 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 border-b border-wood/10 pb-6">
          <div className="-mt-10">
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-sm font-bold text-seal hover:text-seal transition-colors mb-4 uppercase tracking-widest"
            >
            ...
            <p className="text-ink/60 mt-1 text-xs">
              Taslaklarınız 30 gün boyunca saklanır, sonra otomatik silinir.
            </p>
          </div>
        </div>
