          ...
          <div className="p-8 sm:p-10">
            ...
            {isVerified && (
              <div className="bg-emerald-50 border border-emerald-100 text-emerald-700 text-sm p-4 rounded-xl mb-6 flex items-center gap-2">
                ...
                E-posta adresiniz başarıyla doğrulandı. Şimdi giriş
                yapabilirsiniz.
              </div>
            )}
            ...
            {isRegistered && !isVerified && (
              <div className="bg-emerald-50 border border-emerald-100 text-emerald-700 text-sm p-4 rounded-xl mb-6 flex items-center gap-2">
                <CheckCircle2 size={18} className="text-emerald-600" />
                {needsVerify
                  ? "Kaydınız oluşturuldu. Giriş yapmadan önce lütfen e-posta adresinize gönderilen doğrulama bağlantısına tıklayın."
                  : "Kaydınız başarıyla oluşturuldu. Lütfen e-posta adresinizi doğruladıktan sonra giriş yapın."}
              </div>
            )}
            ...
            {authError && (
              <div className="bg-red-50 border border-red-100 text-red-600 text-sm p-4 rounded-xl mb-6 flex items-center gap-2">
                ...
                {authError === "OAuthCallback"
                  ? "Google girişi sırasında bir sorun oluştu. Lütfen tekrar deneyin."
                  : "Giriş yapılamadı: " + authError}
              </div>
            )}

            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-1.5">
                <label className="text-sm font-semibold text-ink-light ml-1">
                  E-posta Adresi
                </label>
                <div className="relative">
                  ...
                  />
                  <Mail
                    className="absolute left-4 top-1/2 -translate-y-1/2 text-wood/50"
                    size={18}
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center ml-1">
                  ...
                  <Link href="#" className="text-xs text-seal hover:underline">
                    Şifremi Unuttum
                  </Link>
                </div>
                <div className="relative">
            ...
            <div className="my-6 flex items-center gap-3">
              ...
              <span className="text-[10px] font-bold text-ink-light/40 tracking-widest uppercase">
                veya
              </span>
              <div className="h-[1px] flex-1 bg-wood/10"></div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-wood/10 text-center">
              <p className="text-sm text-ink-light">
                ...
                <Link
                  href="/auth/register"
                  className="text-seal font-bold hover:underline underline-offset-4"
                >
                  Kayıt Olun
                </Link>
              </p>
    ...
    <Suspense
      fallback={
        <div className="flex-1 flex items-center justify-center p-6">
          <Loader2 className="animate-spin text-wood/50" />
        </div>
      }
    >
      <LoginForm />
