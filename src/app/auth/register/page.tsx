                ...
                <div className="bg-paper border border-wood/20 rounded-2xl shadow-xl overflow-hidden relative">
                    ...
                    <div className="p-8 sm:p-10">
                        <div className="text-center mb-8">
                            <h1 className="font-playfair text-3xl font-bold text-wood-dark mb-2">Aramıza Katılın</h1>
                            <p className="text-ink-light text-sm">Mektuplarınızı kaydetmek ve düzenlemek için üye olun.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div className="space-y-1.5">
                                <label className="text-sm font-semibold text-ink-light ml-1">Ad Soyad</label>
                                <div className="relative">
                                    ...
                                    />
                                    <User className="absolute left-4 top-1/2 -translate-y-1/2 text-wood/50" size={18} />
                                </div>
                            </div>
                            ...
                            <div className="space-y-1.5">
                                <label className="text-sm font-semibold text-ink-light ml-1">Şifre</label>
                                <div className="relative">
                                    <input
                                        type="password"
                                        required
                        ...
                        <div className="mt-8 pt-6 border-t border-wood/10 text-center">
                            <p className="text-sm text-ink-light">
                                Zaten üye misiniz?{" "}
                                <Link href="/auth/login" className="text-seal font-bold hover:underline underline-offset-4">Giriş Yapın</Link>
                            </p>
                        </div>
                    </div>
                </div>

                <p className="text-center text-xs text-paper/60 mt-6">
...
export default function RegisterPage() {
    return (
        <Suspense fallback={<div className="flex-1 flex items-center justify-center p-6 sm:p-10"><Loader2 className="animate-spin text-wood/50" /></div>}>
            <RegisterForm />
        </Suspense>
    );
}
