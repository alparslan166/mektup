...
MEKTUPLAS.COM MESAFELİ SATIŞ SÖZLEŞMESİ

1. TARAFLAR
SATICI: MEKTUPLAS.COM (Bundan sonra "MEKTUPLAS.COM" olarak anılacaktır.)
...
- MEKTUPLAS.COM, sipariş edilen mektubu Alıcı’nın sisteme girdiği metin ve görseller doğrultusunda basar, zarflar ve seçilen gönderim türüne göre kargo/posta kuruluşuna teslim eder.
...
MEKTUPLAS.COM KİŞİSEL VERİLERİN KORUNMASI AYDINLATMA METNİ

6698 sayılı Kişisel Verilerin Korunması Kanunu (“KVKK”) uyarınca, MEKTUPLAS.COM (“Platform”) olarak, veri sorumlusu sıfatıyla kişisel verilerinizi aşağıda açıklanan amaçlar kapsamında ve hukuka uygun olarak işliyoruz.
...
MEKTUPLAS.COM ÜYELİK SÖZLEŞMESİ

1. TARAFLAR
İşbu sözleşme, bir tarafta MEKTUPLAS.COM (Bundan sonra "Platform" olarak anılacaktır) ile diğer tarafta Platform’a üye olan kullanıcı (Bundan sonra "Üye" olarak anılacaktır) arasında, Üye’nin Platform’a kaydı sırasında elektronik ortamda onay vermesi ile akdedilmiştir.
...
Üye, Platform’a bildirdiği e-posta ve telefon numarasının yasal tebligat adresi olduğunu ve bu kanallar üzerinden yapılacak bildirimlerin geçerli sayılacağını kabul eder.
