...
K.V.K.K Hakkında
6698 sayılı Kişisel Verilerin Korunması Kanunu kapsamında kişisel veri olarak tanımlanabilecek müşterilerimize ait ad, soyad, e-posta adresi, T.C. Kimlik numarası, demografik veriler, mali veriler vb. veriler, siparişlerinizi almak, ürün ve hizmetlerimizi sunmak, ürün ve hizmetlerimizi geliştirmek, sistemsel sorunların çözümü, ödeme işlemlerinizi gerçekleştirmek, önceden onay vermeniz halinde siparişleriniz, ürünler ve hizmetler hakkında pazarlama amacıyla, bilgilerinizi güncellemek ve üyeliğinizi yönetmek ve sürdürmek, ilginizi çekebilecek ürün ve hizmetleri önermek ve 3. kişilerin teknik, lojistik ve benzeri diğer işlevlerini Mektuplaş adına yerine getirmelerini sağlamak ve mesafeli satış sözleşmesi ve sair sözleşmelerin ifası amacıyla Mektuplaş, Mektuplaş iştirakleri ve üçüncü kişi ve/veya kuruluşlar tarafından süresiz/süreli kaydedilebilir, yazılı/manyetik arşivlerde muhafaza edilebilir, kullanılabilir, güncellenebilir, paylaşılabilir, transfer olunabilir ve sair suretler ile işlenebilir.
Mektuplaş müşterilerinin www.mektuplas.com internet sitesinin mobil versiyonu-aplikasyonunun (akıllı cihaz uygulamasının) kullandığı hallerde alışverişlerine dair her türlü kişisel olan-olmayan bilgiler de (konum verileri, incelenen ürünler ve alışveriş konusu ürün-tutar bilgileri dahil) uygun teknik yöntemler ile alınabilir, ticari amaçlar ile Mektuplaş, Mektuplaş iştirakleri ve üçüncü kişi ve/veya kuruluşlar tarafından süresiz/süreli kaydedilebilir, yazılı/manyetik arşivlerde muhafaza edilebilir, kullanılabilir, güncellenebilir, paylaşılabilir, transfer olunabilir ve sair suretler ile işlenebilecektir.
Müşterilerimiz her zaman ve hiçbir gerekçe göstermeksizin aşağıda belirtilen iletişim kanallarından Mektuplas.com a ulaşarak kişisel veri kullanımı-işlenmelerini ve/veya kendilerine gönderilen ticari elektronik iletişimleri durdurulmasını talep edebilirler. Müşterilerimizin bu husustaki taleplerinin Mektuplaş'a ulaşmasını müteakip içerisinde kişisel veri işlemleri ve/veya elektronik ticari ileti gönderimi durdurulur. Ancak yürürlükteki mevzuatın izin verdiği/işlenmesi/saklanması/tutulması zorunlu olan veriler işlenmeye veya ticari elektronik ileti gönderimine devam edilebilir. Müşterilerimiz dilerse kişisel verilerinin işlenmesi ile ilgili işlemler hakkında Mektuplas.com a her zaman başvurabilir ve bilgi alabilir. Bu hususlardaki başvuru ve talepleri yasal azami süreler içinde yerine getirilecek yahut hukuki gerekçesi tarafına açıklanarak kabul edilmeyebilecektir.
...
1. TARAFLAR
İşbu sözleşme, bir tarafta EHM DIJITAL COZUMLER YAZILIM VE TICARET LIMITED SIRKETI (Bundan sonra "MEKTUPLAS.COM " olarak anılacaktır) ile diğer tarafta MEKTUPLAS.COM’a üye olan kullanıcı (Bundan sonra "Üye" olarak anılacaktır) arasında, Üye’nin MEKTUPLAS.COM’a kaydı sırasında elektronik ortamda onay vermesi ile akdedilmiştir.

2. ÜYELİK BİLGİLERİ VE TAAHHÜTLER
2.1. Üye; kayıt esnasında kendisinden talep edilen Ad-Soyad, Doğum Tarihi bilgilerini doğru, eksiksiz ve güncel şekilde beyan etmekle yükümlüdür.
2.2. Belirtilen bilgilerin hatalı olması sebebiyle mektup gönderim süreçlerinde yaşanacak aksaklık ve zararlardan Platform sorumlu tutulamaz.

3. HESAP SİLME VE AKTİF GÖNDERİ KISITI
3.1. Üye, dilediği zaman üyeliğini sonlandırma talebinde bulunabilir.
3.2. Ciddiyet ve Operasyonel Güvenlik Kuralı: Üye’nin sistem üzerinde henüz alıcısına ulaşmamış; hazırlık, basım veya kargo aşamasında olan aktif bir gönderisi (mektubu) bulunması durumunda, söz konusu gönderi süreci tamamlanana kadar hesap silme işlemi gerçekleştirilemez. Üyelik iptali ancak aktif gönderi bulunmadığı durumda derhal işleme alınır.

4. GİZLİLİK VE VERİ GÜVENLİĞİ
...
GİZLİLİK POLİTİKASI
İşbu Gizlilik Sözleşmesi MEKTUPLAS.COM ve/veya sair internet sitelerine ilişkin gizlilik politikasını içerir. Mektuplas.com internet sitesini ziyaret ederek aşağıdaki tüm yükümlülükleri ve kuralları kabul etmiş sayılırsınız.
...
Mektuplas.com sitesinde yaptığınız alışverişlerde kullanmış olduğunuz banka/kredi kartına ait bilgiler hiçbir suretle sitemizde saklanmaz ve kaydedilmez. Bu nedenle sitemiz üzerinden vereceğiniz her siparişte banka/kredi kartı bilgilerinizi yeniden girmeniz gerekmektedir.
